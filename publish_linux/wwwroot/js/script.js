...
$("#imgInp").change(function(){readURL(this);});if($('.datatable').length>0){$('.datatable').each(function(){var $t=$(this);var cols=$t.find('thead tr th').length;var validRows=$t.find('tbody tr').filter(function(){return $(this).find('td').length===cols;}).length;if(validRows>0){try{$t.DataTable({"bFilter":false});}catch(e){}}});}
